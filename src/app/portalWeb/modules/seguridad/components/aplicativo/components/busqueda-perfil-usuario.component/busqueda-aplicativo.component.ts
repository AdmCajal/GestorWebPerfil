...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, ButtonModule, RouterModule, RippleModule, ButtonModule, ComponentesCompartidosModule, MantenimientoAplicativo],
    templateUrl: './busqueda-aplicativo.component.html',
    styleUrls: ['./busqueda-aplicativo.component.scss'],
})
export class BusquedaAplicativo implements OnInit, AccionesVistaComponente {
