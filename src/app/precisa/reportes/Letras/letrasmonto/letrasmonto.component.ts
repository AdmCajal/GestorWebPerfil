...
@Component({
  selector: 'ngx-letrasmonto',
  templateUrl: './letrasmonto.component.html'
})
export class LetrasmontoComponent extends ComponenteBasePrincipal implements OnInit, UIMantenimientoController {
  ...
  coreVer(dto){
    ...
    async exportExcel() {
      if (this.lstContrato == null || this.lstContrato == undefined || this.lstContrato.length == 0) {
        ...
        const result = await this.exportarService.exportExcel(this.lstContrato, listaExportar, "Monto_Letra");
        console.log(result);
    ...
    async exportPdf() {
      if (this.lstContrato == null || this.lstContrato == undefined || this.lstContrato.length == 0) {
        ...
        const result = await this.exportarService.ExportPdf(this.lstContrato, col, rows, "Monto_Letra.pdf", "l");
