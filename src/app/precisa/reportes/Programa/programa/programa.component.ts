...
@Component({
  selector: 'ngx-programa',
  templateUrl: './programa.component.html'
})
export class ProgramaComponent extends ComponenteBasePrincipal implements OnInit, UIMantenimientoController {
  ...
  coreVer(dto){
    ...
    async exportExcel() {
      if (this.lstContrato == null || this.lstContrato == undefined || this.lstContrato.length == 0) {
        ...
        const result = await this.exportarService.exportExcel(this.lstContrato, listaExportar, "Programa");
        console.log(result);
